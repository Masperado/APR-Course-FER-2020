...
public class Gradijentni implements Optimization {
    ...
    public Gradijentni(GoalFunction goalFunction, boolean optimal) {
    ...
    public Solution solve(Solution start) {
        ...
        while (result.getGradient().norm() > eps) {
            ...
            if (optimal) {
                ...
                GoalFunction g = new GoalFunction() {
                    ...
                    public double calculate(double x) {
                        ...
                        Matrix m = Matrix.add(matrix, Matrix.mulWithScalar(resultFinal.getGradient(), -x));
            ...
            Matrix m = Matrix.add(matrix, Matrix.mulWithScalar(result.getGradient(), -lamb));
